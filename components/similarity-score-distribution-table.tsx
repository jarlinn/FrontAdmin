...
interface SimilarityScoreDistributionTableProps {
  title?: string
}

export default function SimilarityScoreDistributionTable({
  title = "Distribución por Similarity Score",
}: SimilarityScoreDistributionTableProps) {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Rango de Similarity Score</TableHead>
              <TableHead className="w-32">Rango Numérico</TableHead>
