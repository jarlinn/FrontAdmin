...
interface SubmodalityDistributionPieChartProps {
  title?: string
  height?: number
}
...
export default function SubmodalityDistributionPieChart({
  title = "Distribución por Submodalidad",
  height = 500
}: SubmodalityDistributionPieChartProps) {
